...
Die folgende Abbildung, entnommen aus der  https://docs.cloud.google.com/netapp/volumes/docs["Google Cloud NetApp Volumes-Dokumentation"^], zeigt eine Übersicht auf hoher Ebene.
