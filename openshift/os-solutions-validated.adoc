...
[role="lead"]
Die Lösung testet und validiert Migration & Centralized Data Protection mit OpenShift Container Platform (OCP), OpenShift Advanced Cluster Manager (ACM), NetApp ONTAP, NetApp BlueXP und NetApp Trident Protect.
...
* Verwenden Sie Trident Protect, um Anwendungen zu schützen und die Migration zwischen den On-Premises-Clustern zu unterstützen.
...
* Nutzen Sie Trident Protect, um Anwendungen zu schützen und die Migration zwischen den lokalen Clustern und den selbstverwalteten OpenShift Clustern in AWS zu unterstützen.
...
* Nutzen Sie Trident Protect, um Anwendungen zu schützen und die Migration zwischen lokalen und Google Cloud OpenShift Clustern zu unterstützen.
...
* Nutzen Sie Trident Protect, um Anwendungen zu schützen und die Migration zwischen lokalen Systemen und OpenShift Clustern in Azure zu unterstützen.
