...
Die https://docs.cloud.google.com/netapp/volumes/docs/configure-and-use/active-directory/about-ad["Details zur Active Directory-Verbindung"^] bieten Administratoren Anleitungen, um spezifische Active Directory-Schemainformationen für die Platzierung von Computerkonten anzugeben, wie zum Beispiel die folgenden:
...
Um die AES-Verschlüsselung für NFS Kerberos zu aktivieren, https://docs.cloud.google.com/netapp/volumes/docs/plan-and-prepare/security-considerations["siehe die Google Cloud NetApp Volumes -Dokumentation"^].
