...
NetApp Cloud Volumes ONTAP storage bietet Datenschutz, Zuverlässigkeit und Flexibilität für Container-Bereitstellungen in AWS, Azure und Google Cloud. Trident dient als der dynamische Speicherbereitsteller, um den persistenten Cloud Volumes ONTAP storage für zustandsbehaftete Anwendungen der Kunden zu nutzen. Trident Protect kann für die Datenverwaltungsanforderungen zustandsbehafteter Anwendungen wie Datenschutz, Migration und Geschäftskontinuität verwendet werden.
