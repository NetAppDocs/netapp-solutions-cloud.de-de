...
* Verwenden Sie ein Helm-Chart, um Trident auf OSD-Clustern zu installieren. Siehe link:https://docs.netapp.com/us-en/trident/trident-get-started/kubernetes-deploy-helm.html["hier,"] für Anweisungen zur Installation des Helm-Charts.
